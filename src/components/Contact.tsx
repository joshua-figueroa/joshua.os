				...
				<form ref={formRef} onSubmit={handleSubmit} className="mt-12 flex flex-col gap-8">
					<label className="flex flex-col">
						...
						<input
							...
							className="bg-black-100 py-4 px-6 placeholder:text-secondary text-white-100 rounded-lg outline-none border-none font-medium"
						/>
					</label>
					<label className="flex flex-col">
					...
					<label className="flex flex-col">
						...
						<textarea
							...
							className="bg-black-100 py-4 px-6 placeholder:text-secondary text-white-100 rounded-lg outline-none border-none font-medium resize-none"
						/>
					</label>

					<button
						type="submit"
						className="bg-black-100 py-3 px-8 rounded-xl outline-none w-fit text-white-100 font-bold shadow-md shadow-primary"
					>
